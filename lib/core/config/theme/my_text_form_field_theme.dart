...
hintStyle: TextStyle(fontSize: 13.sp),
    ...
    focusedBorder:TextFormTheme.setOutlineInputBorder(color: AppColors.primaryColor,width: 2),
    errorBorder: TextFormTheme.setOutlineInputBorder(color: AppColors.red,),
    focusedErrorBorder:  TextFormTheme.setOutlineInputBorder(color: AppColors.red,width: 2),
