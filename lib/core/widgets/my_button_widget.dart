...
class MyButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  ElevatedButton(onPressed: onPressed, child: Text(text,style: AppStyles.textStyle18,));
  }
}
...
final String text;
  @override
  Widget build(BuildContext context) {
    return TextButton(onPressed: onTap, child: Text(text,style: AppStyles.textStyle12.copyWith(color: AppColors.primaryColor),));
  }
}
