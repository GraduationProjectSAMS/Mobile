...
class CardsRemoteRepoImpl implements CardsRemoteRepo {
  ...
  @override
  Future<void> addToCard({required productId, required String type,  int quantity=1}) async{
 ...
 @override
  ...
  @override
  Future<void> removeFromCard({required productId, required String type})async {
