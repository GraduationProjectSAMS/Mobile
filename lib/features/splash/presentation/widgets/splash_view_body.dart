...
class SplashViewBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      ...
      // make grid paper
      GridPaper(),
      LongPressDraggable(feedback: Text("data"),
      child: Text("data"),),
      ModalBarrier(),
      ...
      PhysicalModel(color: Colors.red,),
     PhysicalShape(clipper: ShapeBorderClipper(shape: RoundedRectangleBorder()), color: Colors.red,),
