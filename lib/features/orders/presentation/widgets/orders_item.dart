...
class OrdersItem extends StatelessWidget {
                ...
                Column(
                  children: List.generate(
                    3,
                        (index) {
                      final titles = [
                        OrderStatus.fromValue(orderEntity.orderStatus).label, // Restore original status text
                      ...
                      return Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            if (index == 0) // Place dropdown beside first row
  ...
  List<DropdownMenuItem<OrderStatus>> _buildDropdownItems() {
    final currentStatus = OrderStatus.fromValue(orderEntity.orderStatus);
